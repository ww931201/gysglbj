...
(function(){
    ...
    var f = {}, modules = {}, argsT = ['swfUrl', 'id', 'width', 'height', 'debugMode', 'registerWithJS', 'bgColor', 'scaleMode', 'lang', 'detectFlashVersion', 'autoInstallRedirect'];
    ...
    f.core = function(a){
        if (!(this instanceof f.core)) {
            ...
            f.raiseError(this, '25081840', 'run', '', new SyntaxError("Use the \"new\" keyword while creating a new FusionCharts object"))
        }
        var b = {}, prop;
    ...
    var m = {
        outputHelpers: {
            'text': function(e, a){
                ...
                m.outputTo('#' + e.eventId + ' [' + b + '] fired "' + e.eventType + '" event. ' + (e.eventType === 'error' || e.eventType === 'warning' ? a.message : ''))
            },
            'event': function(e, a){
                this.outputTo(e, a)
            },
    ...
    i.extend({
        debugMode: {
            outputFormat: function(a){
                if (a && typeof a.toLowerCase === 'function' && typeof m.outputHelpers[a = a.toLowerCase()] === 'function') {
...
(function(){
    ...
    f.renderer = {
        ...
        update: function(a){
            store[a.id].update.apply(a, Array.prototype.slice.call(arguments, 1))
        },
        render: function(a){
            store[a.id].render.apply(a, Array.prototype.slice.call(arguments, 1))
        },
        resize: function(a){
            store[a.id].resize.apply(a, Array.prototype.slice.call(arguments, 1))
        },
        config: function(a){
            store[a.id].config.apply(a, Array.prototype.slice.call(arguments, 1))
        }
    };
    var j = function(a){
        return function(){
            if (this.ref === undefined || this.ref === null || typeof this.ref[a] !== 'function') {
                f.raiseError(this, '25081617', 'run', '~' + a + '()', 'ExternalInterface call failed. Check whether chart has been rendered.');
                return undefined
            }
    ...
    f.addEventListener('BeforeInitialize', function(a){
        ...
        f.parsePolicies(b, store[b.id].policies ||
        {}, b.args);
    ...
    var l = function(a){
        if (a.success === false) {
            f.raiseError(f.core.items[a.id], '25081850', 'run', '::RendererManager', new Error('There was an error rendering the chart. ' + 'Enable FusionCharts JS debugMode for more information.'))
        }
    ...
    f.extend({
        render: function(a){
            if (window[this.id] !== undefined) {
               // f.raiseError(this, '25081843', 'comp', '.render', new Error('#25081843:IECompatibility() Chart ' + 'Id is same as a JavaScript variable name. Variable naming ' + 'error. Please use unique name for chart JS variable, ' + 'chart-id and container id.'))
            }
            ...
            if (a === undefined || a === null) {
                f.raiseError(this, '03091456', 'run', '.render()', new Error("Unable to find the container DOM element."));
                return this
            }
            if (k(this.id, a)) {
    ...
    g.extend({
        ...
        setChartData: function(a, b, c){
            ...
            if (c !== true) {
                if (this.options.safeMode === true && this.__state.rendering === true && !this.isActive()) {
                    ...
                    g.raiseWarning(this, '23091255', 'run', '::DataHandler~update', 'Renderer update was postponed due to async loading.')
                }
                else {
        ...
        getChartData: function(a, b){
            ...
            if (a === undefined || typeof a.toString !== 'function' || (c = h[a = a.toString().toLowerCase()]) === undefined) {
                g.raiseError(this, '25081543', 'param', '~getChartData()', new Error('Unrecognized data-format specified in "format"'));
                return undefined
            }
    ...
    g.extend({
        transcodeData: function(a, b, c, d){
            if (!b || typeof b.toString !== 'function' || !c || typeof c.toString !== 'function' || h[(c = c.toString().toLowerCase())] === undefined || h[(b = b.toString().toLowerCase())] === undefined) {
                g.raiseError(this, '14090217', 'param', 'transcodeData()', new Error('Unrecognized data-format specified during transcoding.'));
                return undefined
            }
...
(function(){
    ...
    f.extend({
        ...
        chartType: function(){
            var a = this.src.substring(this.src.indexOf('.swf'), 0), file = a.substring(a.lastIndexOf('/') + 1).toLowerCase();
...
(function(){
    ...
    d.extend({
        setChartAttribute: function(a){
            ...
            var i = 0, json = this.getChartData(FusionChartsDataFormats.JSON), prop, attList = json.chart || json.graph ||
            {};
            for (prop in a) {
                i += 1;
        ...
        getChartAttribute: function(a){
            var b = (b = this.getChartData(FusionChartsDataFormats.JSON)).chart || b.graph;
...
(function(){
    ...
    var z = y.swfobject = function(){
        var w = "undefined", OBJECT = "object", SHOCKWAVE_FLASH = "Shockwave Flash", SHOCKWAVE_FLASH_AX = "ShockwaveFlash.ShockwaveFlash", FLASH_MIME_TYPE = "application/x-shockwave-flash", EXPRESS_INSTALL_ID = "SWFObjectExprInst", ON_READY_STATE_CHANGE = "onreadystatechange", win = window, doc = document, nav = navigator, plugin = false, domLoadFnArr = [main], regObjArr = [], objIdArr = [], listenersArr = [], storedAltContent, storedAltContentId, storedCallbackFn, storedCallbackObj, isDomLoaded = false, isExpressInstallActive = false, dynamicStylesheet, dynamicStylesheetMedia, autoHideShow = true, ua = function(){
            ...
            if ((typeof doc.readyState != w && doc.readyState == "complete") || (typeof doc.readyState == w && (doc.getElementsByTagName("body")[0] || doc.body))) {
                                ...
                                if (regObjArr[i].expressInstall && canExpressInstall()) {
                                    ...
                                    for (var j = 0; j < h; j++) {
                                        if (p[j].getAttribute("name").toLowerCase() != "movie") {
                                            g[p[j].getAttribute("name")] = p[j].getAttribute("value")
                                        }
                                    }
        ...
        function showExpressInstall(a, b, c, d){
            ...
            if (e) {
                ...
                var f = ua.ie && ua.win ? "ActiveX" : "PlugIn", fv = "MMredirectURL=" + win.location.toString().replace(/&/g, "%26") + "&MMplayerType=" + f + "&MMdoctitle=" + doc.title;
    ...
    var B = /[\\\"<>;]/;
    var C = function(s){
        return (B.exec(s) !== null) && typeof window.encodeURIComponent !== undefined ? window.encodeURIComponent(s) : s
    };
    var D = function(e, a){
    ...
    window.__fusioncharts_vars = function(a, b){
        ...
        if (!(c instanceof y.core)) {
            y.raiseError(y.core, '25081621', 'run', '::FlashRenderer', 'FusionCharts Flash object is accessing flashVars of non-existent object.');
            return false
        }
        if (typeof b === 'object') {
    ...
    y.addEventListener('BeforeInitialize', function(a){
        ...
        if (Boolean(b.options.autoInstallRedirect) === true && !y.swfobject.hasFlashPlayerVersion(y.core.options.requiredFlashPlayerVersion.toString()) && A === false) {
            A = true;
    ...
    E.prototype = {
        getSWFHTML: function(){
            var a = document.createElement('span'), inElm = document.createElement('span'), tempId = 'RnVzaW9uQ2hhcnRz' + (new Date()).getTime();
            a.appendChild(inElm);
            inElm.setAttribute('id', tempId);
            a.style.display = 'none';
            document.getElementsByTagName('body')[0].appendChild(a);
            y.swfobject.embedSWF(this.src, tempId, this.width, this.height, '8.0.0', undefined, this.flashVars, this.params, this.attrs);
...
(function(){
    ...
    FCC.init = function(){
            ...
            method: {
                ...
                exportChart: function(a){
                    ...
                    if (HCObj.options.exporting.enabled) {
                        if (typeof a === 'object') {
                            for (var x in a) {
                                if (x.toLowerCase() === 'exportformat' && FCFCC.exportFormat[a[x].toLowerCase()]) {
                                    HCConf.type = FCFCC.exportFormat[a[x].toLowerCase()]
                                }
                                else 
                                    if (x.toLowerCase() === 'exportfilename') {
                                        HCConf.filename = a[x]
                                    }
                            }
                        }
        ...
        function createContainer(a, b, c, d, e){
            var f = document.getElementById(b), __container = document.getElementById(a), lengthPercentageRegExp = /\%\s*?$/ig;
            if (e === true) {
                if (f) {
        ...
        function showChartMessage(a){
            ...
            M.extend(c, this.FusionCharts.link.parent.link.configuration().overlayButton ||
            {});
        ...
        var C = function(a, b){
            ...
            if ((a === 2 && this.link) || (a === 1 && this.options.chart.link)) {
                if (a === 2 && this.link) {
                    c = b == '0' ? this.link : window.decodeURIComponent(this.link);
                    c.replace(/^[\s]*/, '');
                    arr = this.link.split('-');
                    ...
                    if (a === 1 && this.options.chart.link) {
                        c = b == '0' ? this.options.chart.link : window.decodeURIComponent(this.options.chart.link);
                        c.replace(/^[ ]*/, '');
                ...
                switch (arr[0].toLowerCase()) {
                    ...
                    case 'j':
                        ...
                        break;
                    case 'p':
                        A = window.open(arr[2], arr[1].match(/[^,]+/i), arr[1].replace(/[^,]+,/i, ''));
                        if (window.focus) {
                            A.focus()
                        }
                        break;
                    case 'newchart':
                        var d = arr[1].toLowerCase().search('url') != -1 ? 'URL' : FusionChartsDataFormats.JSON, data, x, chartJson, linkchartId;
                        if (d === 'URL') {
                            data = c.replace(/[^\-]+-[^\-]+-/i, '')
                        }
                        else {
                            chartJson = M.core.items[chartId].getChartData(FusionChartsDataFormats.JSON);
        ...
        var F = function(a, b){
            ...
            if (!FCFCC.highCharts[chart]) {
                ...
                if (n[id].msgTxt) {
                    ...
                    if (this.jsVars && this.jsVars.LoadError) {
                        HCJson = createMsg(id, 'LoadDataErrorText', undefined)
                    }
                    else 
                        if (this.jsVars && this.jsVars.stallLoad) {
        ...
        var H = function(a, b){
            ...
            var c = FCFCC.method.getExternalInterfaceMethods(b.chartType()).split(','), i;
                ...
                plotOptions: {
                    series: {
                        ...
                        dataLabels: {
                            ...
                            style: {},
                            formatter: function(){
                                var x, y, showvalue = this.point.options.showvalue || this.series.options.showvalue || this.series.chart.options.chart.showvalue;
                                if (this.series.type == 'pie') {
                                    x = (a.chart.showlabels === '0' || !this.point.FCname ? '' : this.point.FCname);
                                    y = showvalue === '1' ? (Math.round(this.percentage * 100) / 100) + (a.chart.showpercentagevalues === '1' ? '%' : '') : '';
                        ...
                        if (this.point.options.tooltext) {
                            ...
                            if (this.series.options.FCtype == 1.5 && this.series.type == 'line') {
                                ...
                                if (this.series.type == 'pie') {
                                    ...
                                    if (this.series.options.FCtype === 2.5) {
                                        x = v(this.y, a.chart, 1)
                                    }
                                    else {
                                        x += v(this.y, a.chart, 1)
        ...
        function addPoint(a, b, c, d, e, f, g, h, i){
            var x, y, isAbs = FCFCC.valueAbs[d], value, seriesType = a.type || f.chart.defaultSeriesType, dataseperator, tempY, dataYmax, dataYmin, loopMax;
            if (!a.yAxis) {
                dataYmax = 'dataY0max';
                dataYmin = 'dataY0min'
            }
                ...
                for (y = 0; y < loopMax; y += 1) {
                    if (typeof b[y] === 'object') {
                        if (!b[y].vline) {
                            ...
                            a.data.push({
                                y: tempY || 0,
                                x: (isAbs ? Math.abs(parseFloat(b[y].x)) : parseFloat(b[y].x)) || undefined,
                                z: (isAbs ? Math.abs(parseFloat(b[y].z)) : parseFloat(b[y].z)) || undefined,
                                ...
                                marker: (seriesType === 'areaspline' || seriesType === 'spline' || seriesType === 'area' || seriesType === 'line') ? {
                                    ...
                                    radius: b[y].z ? Math.round((b[y].z / h) * 10) / 10 : undefined
                                } : null)
                            });
                            if (c < 2) {
                                f.xAxis.categories.push(b[y].showlabel === '0' ? '' : (b[y].label || ''))
                            }
                        }
                        else 
                            if (c < 2) {
                        ...
                        if (typeof b[y] === 'string' && i.chart.compactdatamode == '1') {
                ...
                for (x = 0; x < a.categories[0].category.length; x += 1) {
                    if (typeof a.categories[0].category[x] === 'object') {
                        if (!a.categories[0].category[x].vline) {
                            if (b == 2.5) {
                                zoomCat.push(a.categories[0].category[x].label ? a.categories[0].category[x].label : '')
                            }
                            else {
                                c.xAxis.categories.push(a.categories[0].category[x].label ? a.categories[0].category[x].label : '')
                            }
                            countCat += 1
                        }
                        else {
                        ...
                        if (typeof a.categories[0].category[x] === 'string' && a.chart.compactdatamode == '1') {
                            dataseperator = a.chart.dataseparator ? a.chart.dataseparator : '|';
                            if (b == 2.5) {
                                zoomCat = zoomCat.concat(a.categories[0].category[x].split(dataseperator))
                            }
                            else {
                                c.xAxis.categories = c.xAxis.categories.concat(a.categories[0].category[x].split(dataseperator))
                            }
                        }
                }
            }
        ...
        function MSStacked(b, c, d, e, f, g, h, i){
            var x, y, z, newSeries, count_set = 0, max_cat = 0, a = [], plotWidth = f - (e.chart.margin[1] + e.chart.margin[3]), plotHight = g - (e.chart.margin[0] + e.chart.margin[2]), noStack, pointWidth, catWidth, tempheight, maxHight = 0, pointValue = 0;
                ...
                for (x = 0; x < b.dataset.length; x += 1) {
                    ...
                    if (b.dataset[x].dataset && b.dataset[x].dataset instanceof Array) {
                        for (y = 0; y < b.dataset[x].dataset.length; y += 1) {
                            newSeries = {
                                FCtype: c,
                                type: b.dataset[x].dataset[y].renderas ? FCFCC.combi[b.dataset[x].dataset[y].renderas.toLowerCase()] : undefined,
        ...
        function addData(c, d, e, f, g, h, i){
            ...
            getScolor = function(a){
                var b;
                b = (c.chart.palettecolors) ? ((typeof c.chart.palettecolors === 'string') ? c.chart.palettecolors.split(',') : c.chart.palettecolors) : FCFCC.color;
                return b[a % b.length]
            };
            switch (d) {
                case 1:
                ...
                case 7.5:
                    ...
                    if (c.dataset) {
                        ...
                        for (x = 0; x < c.dataset.length; x += 1) {
                            ...
                            z.marker = {
                                symbol: (d == 7.5) ? 'circle' : w(parseInt(c.dataset[x].anchorsides, 10)),
                                states: {
                                    hover: {
                                        enabled: false
                                    }
        ...
        function convertMarimeko(a, b, c, d, e){
            var f = c - (a.chart.margin[1] + a.chart.margin[3]), plotHight = d - (a.chart.margin[0] + a.chart.margin[2]), y, z, arr = [], total = 0, temp, setPersent = false, catCountFlag = true, temp2, totalpercent = 0;
            ...
            for (y = 0; y < a.series.length; y += 1) {
                ...
                for (z = 0; z < a.series[y].data.length; z += 1) {
                    ...
                    if (catCountFlag && b.chart.showxaxispercentvalues != '0' && totalpercent < 0.9) {
                        a.labels.items.push(createText((Math.round(totalpercent * 10000) / 100) + '%', plotHight - 15, temp - 20))
                    }
                }
                catCountFlag = false
            }
                ...
                for (j = 0; j < c.styles.application.length; j += 1) {
                    ...
                    for (l = 0; l < styleArr.length; l += 1) {
                        ...
                        if (tempstyle[styleName]) {
                            FCFCC.supportedStyle[tempstyle[styleName].type](g, c.styles.application[j].toobject.toLowerCase(), tempstyle[styleName])
                        }
                    }
                }
            }
    ...
    M.extend({
        '_fallbackJSChartWhenNoFlash': function(){
            if (!M.swfobject.hasFlashPlayerVersion(M.core.options.requiredFlashPlayerVersion)) {
                M.renderer.setDefault('javascript')
            }
        }
    })
...
(function(){
    ...
    var k = function(s){
        ...
        s = s.toString().replace(/&/g, '&amp;').replace(/\'/g, '&#39;').replace(/\"/g, '&quot;').replace(/</g, '&lt;').replace(/>/g, '&gt;');
        return s
    };
    var l = (function(){
        var e = {
            ...
            child: function(a, b, c, d){
                ...
                for (i = 0; i < b.length; i += 1) {
                    ...
                    if (b[i].nodeType === f) {
                        ...
                        if (b[i].nodeType === XML_TEXTNODE && d.chart && parseInt(d.chart.compactdatamode, 10) && typeof e.text[c] === 'string') {
                            nodeName = e.text[c];
                            childObj = b[i].data;
                            g.append(childObj, a, nodeName)
                        }
        ...
        var h = function(a){
            ...
            if (window.DOMParser) {
                xmlDoc = (new window.DOMParser()).parseFromString(a, "text/xml")
            }
            else {
    ...
    var m = (function(){
        var d = {
            ...
            qualify: function(a, b, c){
                c = c.toLowerCase();
                return typeof this.items[a][c] === 'object' ? this.items[a][c][b.toLowerCase()] : this.items[a][c]
            }
        };
        var f = function(a, b){
...
(function(){
        ...
        configureLink: function(a, b){
            if (a instanceof Array) {
                ...
                if (typeof a === 'object') {
                    ...
                    f.raiseError(this, '25081731', 'param', '~configureLink()', 'Unable to update link configuration from set parameters')
                }
        }
    }, true);
    f.addEventListener('BeforeInitialize', function(a){
    ...
    f.addEventListener('LinkedChartInvoked', function(a, b){
        var c = a.sender, param = c.clone({
            dataSource: b.data,
            dataFormat: b.linkType === 'URL' ? FusionChartsDataFormats.XMLURL : b.linkType,
...
(function(){
    ...
    var l = {
        ...
        rle2array: function(a, b){
            ...
            for (run in c) {
                ...
                for (i = 0; i < c[run].length; i += 2) {
                    c[run][i] = c[run][i] === '' ? b : ('000000' + c[run][i]).substr(-6)
                }
            }
            return c
        },
        ...
        drawText: function(a, b, c, d){
            ...
            if (typeof e.fillText === 'function') {
                ...
                if (typeof e.mozDrawText === 'function') {
                    e.translate(w / 2, h / 2);
                    e.mozDrawText(b)
                }
                else {
    ...
    var n = function(a){
        ...
        try {
            ...
            m.invoke('error');
            j.raiseError(a.sender, '25081807', 'run', '::PrintManager>onDrawComplete', 'There was an error while showing message to user via canvas.')
        }
    ...
    j.extend({
        printManager: {
            ...
            enabled: function(a){
                ...
                if ('\v' === 'v' || j.renderer.currentRendererName() !== 'flash' || typeof document.createElement('canvas').getContext !== 'function') {
                    k.bypass = true;
                    j.raiseEvent('PrintReadyStateChange', {
                        ready: true,
                        bypass: k.bypass
                    });
                    j.raiseWarning(j.core, '25081816', 'run', '.printManager.enabled', 'printManager is not compatible with your browser');
                    return k.enabled
                }
                k.bypass = false;
                subscribeToEvents(a);
